...
class ProductPage(BasePage):
    ...
    def check_adding_book_to_the_shopping_cart(self):
        ...
        book_name_added_in_cart = self.is_element_visible(ProductPageLocators.BOOK_NAME_ADDED_TO_CART).text
    ...
    def check_book_price_in_the_shopping_cart(self):
        ...
        book_price_added_in_cart = self.is_element_visible(ProductPageLocators.COST_OF_THE_SHOPPING_CART).text
        assert book_price == book_price_added_in_cart, "The book price doesn't match"

    def should_not_be_success_message(self):
        assert self.is_not_element_present(ProductPageLocators.BOOK_NAME_ADDED_TO_CART), \
            "Success message is presented, but should not be"

    def success_message_is_disappeared(self):
        assert self.is_disappeared(ProductPageLocators.BOOK_NAME_ADDED_TO_CART), \
